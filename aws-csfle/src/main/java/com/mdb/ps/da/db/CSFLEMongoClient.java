...
import com.mdb.ps.bo.TestCollection.TestCollectionSchema;
...
public class CSFLEMongoClient {
  
  private static MongoClient instance;
  private final static String URI = "<mongo_uri>";


  private CSFLEMongoClient() {}
  ...
  private static MongoClient createInstance(String uri, KMSProvider kmsProvider, boolean isArray) {
    ...
    MongoClientSettings settings = MongoClientSettings.builder()
      ...
      .autoEncryptionSettings(AutoEncryptionSettings.builder()
        ...
        .schemaMap(combineSchemas(kmsProvider.getDekId(), isArray))
